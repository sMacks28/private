...
Die Kriterien von DiVincenzo bieten eine kurze Zusammenfassung, welche Eigenschaften notwendig sind, um ein physikalisches System
...
\begin{figure}
    ...
    \caption{Illustration von Phasenkohärenz und Dekohärenz. Letzteres wird im unteren Teil der Abbildung gezeigt. Der blaue Kreis
...
\begin{figure}[h!]
    ...
    \caption{Illustration der unterscheidbaren Polarisationszustände eines Photons.}
\end{figure}
Außerdem reagieren
...
Wellenleiter (meist optische Faser), um das Photon auch führen zu können. 
